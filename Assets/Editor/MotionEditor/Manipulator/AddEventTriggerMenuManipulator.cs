...
namespace Motion
{
    class AddEventTriggerMenuManipulator : NewEventMenuManipulator
    {
        private EventTriggerControl _control;

        public AddEventTriggerMenuManipulator(WindowState state, EventTriggerControl control) : base(state)
        {
            _control = control;
        }
