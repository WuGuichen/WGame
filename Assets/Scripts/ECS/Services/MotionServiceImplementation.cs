...
//                 if (isEmpty)
//                 {
//                     entity.RemoveMotionAttack1();
//                 }
//                 else
//                 {
//                     entity.ReplaceMotionAttack1(WAbilityMgr.Inst.GetAbilityID(name));
//                 }
//                 break;
...
//                 else
//                 {
//                     entity.ReplaceMotionAttack2(WAbilityMgr.Inst.GetAbilityID(name));
//                 }
//                 break;
...
//                 else
//                 {
//                     entity.ReplaceMotionAttack3(WAbilityMgr.Inst.GetAbilityID(name));
//                 }
//                 break;
//         }
//     }
...
//             MotionType.JumpAttack when(character.isPrepareJumpAttackState && entity.hasMotionJumpAttack) => entity.motionJumpAttack.UID,
//             _ => -1,
//         };
//     }
//     
...
//             MotionType.JumpAttack when(entity.hasMotionJumpAttack) => entity.motionJumpAttack.UID,
//             _ => -1,
//         };
//     }
//     #endregion
