...
namespace WGame.UI
{
	public class MainBinder
	{
		...
		{
			UIObjectFactory.SetPackageItemExtension(WGame.UI.Main.FUI_GameMainView.URL, typeof(WGame.UI.Main.FUI_GameMainView));
			UIObjectFactory.SetPackageItemExtension(WGame.UI.Main.FUI_MainListItem.URL, typeof(WGame.UI.Main.FUI_MainListItem));
