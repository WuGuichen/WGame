...
namespace Shapes.Samples.Circles
{
	...
	public class CircleDebugRenderer : MonoBehaviour {
		...
		private void Update()
		{
			...
			// {
			// 	Circle.Draw(circleInfo, gameObject.AddComponent<MeshFilter>(), gameObject.AddComponent<MeshRenderer>());
			// }
			// else
			// {
			// 	Circle.Draw(circleInfo, gameObject.GetComponent<MeshFilter>(), gameObject.GetComponent<MeshRenderer>());
			// }
			//
