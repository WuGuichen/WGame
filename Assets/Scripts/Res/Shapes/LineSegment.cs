...
namespace Shapes
{
	public static class LineSegment
	{
		...
		private static float antiAliasingSmoothing = 1.5f;
		private static readonly Material[] _lineMaterials = new Material[8];
		...
		private static readonly string _colorParam = "_Color";
		private static readonly string _antiAliasingSmoothingParam = "_AASmoothing";
		private static readonly string _fillWidthParam = "_FillWidth";
		private static readonly string _borderColorParam = "_BorderColor";
		private static readonly string _lineLengthParam = "_LineLength";
		private static readonly string _distanceBetweenDashesParam = "_DistanceBetweenDashes";
		private static readonly string _dashWidthParam = "_DashWidth";
		private static readonly string _arrowHeadBaseEdgeNoAAMinX = "_BaseEdgeNoAAMinX";
		private static readonly string _arrowHeadBaseEdgeNoAAMaxX = "_BaseEdgeNoAAMaxX";
